...
y=25 
print(x+y)
# this will give error because we cannot concatenate string and integer''' 
...
# this will print string and integer with space in between them 
x,y,z="python","programming","language" #it is also possible to assign multiple values to multiple variables in one line 
print(x,y,z) 

'''x,y,z="python","programming","language","java"
#if we have more values than variables then it will give error 
print(x,y,z) ''' 
